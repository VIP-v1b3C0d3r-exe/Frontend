...
const createStarIcon = (color) =>
  L.divIcon({
    ...
    html: `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 51 48">
      <path fill="${color}"
        d="M25 1l6 17h18L36 29l5 17-16-11-16 11 5-17L1 18h18z"/>
    </svg>`,
    iconSize: [28, 28],
    iconAnchor: [14, 14],
    popupAnchor: [0, -16],
...
const MOCK_EVENTS = [
  { id: 1, title: "Jazz Night", category: "Music", status: "upcoming", lat: 54.6872, lng: 25.2797, time: "8:00 PM", location: "Old Town" },
  { id: 2, title: "React Workshop", category: "Workshops", status: "current", lat: 54.6912, lng: 25.2701, time: "2:00 PM", location: "Tech Hub" },
  ...
  { id: 6, title: "Indie Concert", category: "Music", status: "upcoming", lat: 54.6860, lng: 25.2650, time: "9:00 PM", location: "Loftas" },
    ...
    <div className={styles.mapPage}>
      <div className={styles.topBar}>
        <div className={styles.searchBox}>
          <svg className={styles.searchIcon} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
